...
<?php
$count=1;
$sel_query="Select * from blog where id =7;";
...
<?php echo "<img style=width:100% src = images/".$row['image'];?> </br>
    <div class="w3-container">
      ...
      <h5> <span class="w3-opacity"> September 20, 2021</span></h5>
    </div>
...
<div class="w3-col l4">
  ...
  <img src="images/ff.jfif" style="width:100%">
    <div class="w3-container w3-white">
    
      <p>A fitness blog is an online tool that lets you share your best advice, information, and expertise, and other people.
	  Fitness blog ideas include ‘how-to’ instructional posts, fitness club news, interesting training techniques, and nutrition tips, and more. A successful fitness blogger focuses on the reader and the fitness journey they are on. 
	  The content should solve the problem the reader has and help them achieve whatever goal they have.</div><hr>
  ...
  <div class="w3-card w3-margin">
    ...
    <div class="w3-container w3-white">
    <p><span class="w3-tag w3-black w3-margin-bottom">Fitness</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Technology</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">London</span>
...
<footer class="w3-center w3-black w3-padding-16">
  ...
  <button class="w3-button w3-black w3-padding-large w3-margin-bottom"><a href="food.php">Next »</a></button>

...
<?php
$count=1;
$sel_query="Select * from blog where id =2;";
...
<div class="w3-col l4">
  ...
  <img src="images/lifestyle1.png" style="width:100%">
    <div class="w3-container w3-white">
    
      <p>A lifestyle blog is a website created by a person that showcases moments of the author’s life. 
	  It is not limited to their craft; blogs tend to incorporate their interests and even their struggles. 
	  Lifestyle blogs can fit into various macro-niches.
	  These blogs can be curated to provide information, advice, and inspiration to their readers.  </div><hr>
  ...
  <div class="w3-card w3-margin">
    ...
    <div class="w3-container w3-white">
    <p><span class="w3-tag w3-black w3-margin-bottom">Lifestyle</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Technology</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">London</span>
...
<footer class="w3-center w3-black w3-padding-16">
  ...
  <button class="w3-button w3-black w3-padding-large w3-margin-bottom"><a href="technology.php">Next »</a></button>

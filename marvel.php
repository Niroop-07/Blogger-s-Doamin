...
<?php
$count=1;
$sel_query="Select * from blog where id =5;";
...
<div class="w3-col l4">
  ...
  <img src="images/m.svg" style="width:100%">
    <div class="w3-container w3-white">
    
      <p>The Marvel Cinematic Universe (MCU) is an American media franchise and shared universe centered on a series of superhero films produced by Marvel Studios.
  ...
  <div class="w3-card w3-margin">
    ...
    <div class="w3-container w3-white">
    <p><span class="w3-tag w3-black w3-margin-bottom">Marvel</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Technology</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">London</span>
...
<footer class="w3-center w3-black w3-padding-16">
  ...
  <button class="w3-button w3-black w3-padding-large w3-margin-bottom"><a href="travel.php">Next »</a></button>

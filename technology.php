...
<?php
$count=1;
$sel_query="Select * from blog where id =3;";
...
<?php echo "<img style=width:100% src = images/".$row['image'];?> </br>
    <div class="w3-container">
      ...
      <h5> <span class="w3-opacity">December 26, 2021</span></h5>
    </div>
...
<div class="w3-col l4">
  ...
  <img src="images/tec.jpeg" style="width:100%">
    <div class="w3-container w3-white">
    
      <p>Technical blogging is a great way to share your expertise while building a potentially valuable readership.
	  It can help you to document projects, or provide guidance to other web users. 
	  You can also monetize your content, or use your blog to market your services.
	  While technical blogs have the same general characteristics as non-technical blogs, 
	  refining your blogging technique will help to make the technical content of your blogs more accessible </div><hr>
  ...
  <div class="w3-card w3-margin">
    ...
    <div class="w3-container w3-white">
    <p><span class="w3-tag w3-black w3-margin-bottom">Technology</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Lifestyle</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">London</span>
...
<footer class="w3-center w3-black w3-padding-16">
  ...
  <button class="w3-button w3-black w3-padding-large w3-margin-bottom"><a href="game.php">Next »</a></button>

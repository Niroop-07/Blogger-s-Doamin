...
<?php echo "<img style=width:100% src = images/".$row['image'];?> </br>
    <div class="w3-container">
      ...
      <h5> <span class="w3-opacity">July 2, 2021</span></h5>
    </div>
...
<div class="w3-col l4">
  ...
  <img src="images/sp2.jpeg" style="width:100%">
    <div class="w3-container w3-white">
    
      <p>Sports blogs are another interesting type of blogs online. Every country in the world has different sports and every sport has its own stars.
	  Sports blogging may also include bloggers who are writing paid content for teams, athletes, and other organizations.</div>
  </div><hr>
  ...
  <div class="w3-card w3-margin">
    ...
    <div class="w3-container w3-white">
    <p><span class="w3-tag w3-black w3-margin-bottom">Sports</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Technology</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">London</span>
      <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Travel</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Fitness</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">DIY</span>
      <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Food</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Lifestyle</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Family</span>
      <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Gaming</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Clothing</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Shopping</span>
      <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Marvel</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Games</span>
    </p>
    </div>
  </div>
</div>
...
<footer class="w3-center w3-black w3-padding-16">
  ...
  <button class="w3-button w3-black w3-padding-large w3-margin-bottom"><a href="lifestyle.php">Next »</a></button>

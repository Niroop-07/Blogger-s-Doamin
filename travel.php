...
<?php
$count=1;
$sel_query="Select * from blog where id =6;";
...
<?php echo "<img style=width:100% src = images/".$row['image'];?> </br>
    <div class="w3-container">
      ...
      <h5> <span class="w3-opacity">July 06, 2021</span></h5>
    </div>
...
<div class="w3-col l4">
  ...
  <img src="images/tr.png" style="width:100%">
    <div class="w3-container w3-white">
    
      <p>Travel blogging is sharing your travel experiences. 
	  Be it about a road trip, cultural practices or local food customs. 
	  You just write what you felt on a trip. Just one request, please don't make it sound like a travel brochure. 
	  You can check out my blog for a sample Walk and Explore</div><hr>
  ...
  <div class="w3-card w3-margin">
    ...
    <div class="w3-container w3-white">
    <p><span class="w3-tag w3-black w3-margin-bottom">Travel</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Technology</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">London</span>
      <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Marvel</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Fitness</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">DIY</span>
...
<footer class="w3-center w3-black w3-padding-16">
  ...
  <button class="w3-button w3-black w3-padding-large w3-margin-bottom"><a href="fitness.php">Next »</a></button>

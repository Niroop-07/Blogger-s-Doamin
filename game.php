...
<?php
$count=1;
$sel_query="Select * from blog where id =4;";
...
<?php echo "<img style=width:100% src = images/".$row['image'];?> </br>
    <div class="w3-container">
      ...
      <h5> <span class="w3-opacity">December 25, 2021</span></h5>
    </div>
...
<div class="w3-col l4">
  ...
  <img src="images/gam.webp" style="width:100%">
    <div class="w3-container w3-white">
    
      <p>Gaming bloggers have plenty of content they can choose from. 
	  They can be game reviewers, reviewing the latest games and hardware. 
	  As games are pricey, many people will want to hear from others before they buy the latest game.
	  Gaming bloggers are often streamers, recording themselves playing and reacting to games. </div><hr>
  ...
  <div class="w3-card w3-margin">
    ...
    <div class="w3-container w3-white">
    <p><span class="w3-tag w3-black w3-margin-bottom">Gaming</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Technology</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">London</span>
      ...
      <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Lifestyle</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Clothing</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">Shopping</span>
...
<footer class="w3-center w3-black w3-padding-16">
  ...
  <button class="w3-button w3-black w3-padding-large w3-margin-bottom"><a href="marvel.php">Next »</a></button>
